					...
					for (var i = 0; i < keys.length; i++) {
                        ...
                        <div class="col-md-5">
                            ...
                            <div style="float: left; width: 80%">
                                ...
                                <p class="multi-tracking-edit" style="display:none">Tracking number: <input class="form-control input-sm tracking-value" style="width: 230px;height: 25px;display: inline;"></p>
