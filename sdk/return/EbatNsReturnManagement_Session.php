<?php 
// $Id: EbatNsReturnManagement_Session.php,v 1.2 2008-06-05 08:21:06 michael Exp $
// $Log: EbatNsReturnManagement_Session.php,v $

require_once 'EbatNsReturnManagement_Defines.php';

class EbatNsReturnManagement_Session {
   ...
   * 
   * @access public 
   * @param string $value The new value for the GlobalId property
   * @return void 
   */
  function setGlobalId($value)
  {
    $this->_props['GlobalId'] = $value;
  }
  /**
  ...
  function _init()
  {
    ...
    $this->_props['GlobalId'] = EBAY_NOTHING;
  ...
  function setAppMode($value)
  {
    ...
    switch ($value) {
      case 0:
        $this->_setProp('ApiUrl', 'http://svcs.ebay.com/services/search/FindingService/v1');
        break;
      case 1:
        $this->_setProp('ApiUrl', 'http://svcs.sandbox.ebay.com/services/search/FindingService/v1');
        break;
      case 2:
        $this->_setProp('ApiUrl', 'http://svcs.ebay.com/services/search/FindingService/v1');
        break;
