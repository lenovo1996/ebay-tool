<?php
// $Id: EbatNsReturnManagement_SimpleType.php,v 1.2 2013-04-05 11:15:53 thomasbiniasch Exp $
// $Log: EbatNsReturnManagement_SimpleType.php,v $

class EbatNsReturnManagement_SimpleType
{ 
	// type-name
	public $_typeName;
	// namespace (prefix)
